                    ...
                    <div className="w-7/12 pl-16">
                        ...
                        <div className="text-lg text-black leading-8">
                            <div className="pb-8">
                                ...
                                at the University of British Columbia. I'm
                                passionate about
                                <br />
                                leveraging technology to drive transformative
                                change in the world in areas like entertainment,
                                healthcare,
                                <br />
                                productivity and beyond through software
                                development and AI!
                            </div>
                            <div>
                                ...
                                song on the piano,
                                <br />
                                or exploring the world, trying to find the
