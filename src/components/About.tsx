            ...
            <div className="h-screen flex flex-col justify-center items-center">
                <div className="w-5/6 mx-auto">
                    ...
                    <div className="pb-8">
                        ...
                        the world in areas like entertainment, healthcare,
                        <br />
                        productivity and beyond through software development and
                        AI!
                    </div>
                    <div>
                        When I'm not coding, you can find me skiing the local
                        mountains, going on hikes, learning a new song on the
                        piano,
                        <br />
                        or exploring the world, trying to find the tastiest
                        foods and the best spots to capture the perfect photo.
                    </div>
                </div>
            </div>
        </>
